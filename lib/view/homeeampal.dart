...
class Homeeampal extends StatefulWidget {
  const Homeeampal({super.key});

  @override
  State<Homeeampal> createState() => _HomeeampalState();
}

class _HomeeampalState extends State<Homeeampal> {
  List<Carddetails> carddetails = [
    Carddetails(
        address: "xyz,manipur mumbai 11",
        name: " Saddam Shaikh",
        posintion: "sofware devaloper",
        companyName: "saddam solution",
        number: "+0000000",
    ...
    Carddetails(
        address: "xyz,manipur mumbai 11",
        name: " sohail Shaikh",
        posintion: "flutter devaloper",
        companyName: "inova solution",
        number: "+0000000",
    ...
    Carddetails(
        ...
        name: " shaban Shaikh",
        posintion: " doctar",
        companyName: "logic solution",
        number: "+0000000",
        email: "shaban@gmail.com",
        image: "assets/Home/Card image.png",
        website: "www.logic.com"),
    Carddetails(
        address: "xyz,manipur mumbai 11",
        name: " sabrin Shaikh",
        posintion: " HR",
        companyName: "Hr solution",
        number: "+0000000",
        email: "sabrin@gmail.com",
        image: "assets/Home/Card image.png",
        website: "www.Hrsln.com")
  ];
  @override
